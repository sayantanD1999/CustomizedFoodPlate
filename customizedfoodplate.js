                ...
                if (data[i].foodkind == "starter") {
                    starter +=
                        ...
                        <div class="card-body">
                            ...
                            <div style="display: flex; justify-contents:center; align-items:center;" ><h5 class="card-title">₹ ${data[i].dataprice}</h5> <input id="ip" type="checkbox" data-food_type=${data[i].foodtype} data-food_kind=${data[i].foodkind} class="item" value=${data[i].value} data-price=${data[i].dataprice}></div>
